...
class ViewController: UIViewController {
    ...
    @IBAction func answerButton(_ sender: UIButton) {
        print("Answer please")
        answerLabel.isHidden = answerLabel.isHidden ? false : true
    }
    @IBAction func nextButton(_ sender: UIButton) {
        currQuest = currQuest == quizBank.count - 1 ? 0 : currQuest + 1
        print("Next please")
        viewDidLoad()
    }
    @IBAction func prevButton(_ sender: UIButton) {
        currQuest = currQuest == 0 ? 0 : currQuest - 1
        print("Previous please")
        viewDidLoad()
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        questionLabel.text = quizBank[currQuest].0
        answerLabel.text = quizBank[currQuest].1
